...
export default function CardTableCategories({ color }) {
  ...
  const handleSearch = async (e) => {
    ...
    return CategoryService.searhCategory(`${values}`)
      .then((response) => {
      ...
      >
        <div className="rounded-t mb-0 px-4 py-3 border-0">
          <div className="flex flex-wrap items-center">
            ...
            >
              <i className="fa fa-plus"></i> Add Medecine Category
            </button>
          </div>
        </div>
        <div className="block w-full overflow-x-auto">
          {/* Add category */}
          {<AddCategory isOpen={isOpen} close={closeModal} />}
...
CardTableCategories.defaultProps = {
  color: "light",
};

CardTableCategories.propTypes = {
