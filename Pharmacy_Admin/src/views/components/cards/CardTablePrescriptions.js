...
export default function CardTablePrescriptions({ color }) {
  ...
  const loadPrescriptions = () => {
    PrescriptionService.getPrescriptions().then((c) =>
  ...
  const handleSearch = async (e) => {
    ...
    return PrescriptionService.searhPrescription(`${values}`)
      .then((response) => {
...
CardTablePrescriptions.defaultProps = {
  color: "light",
};

CardTablePrescriptions.propTypes = {
