...
import DatatableShipper from "../Datatable/DatatableShipper";
import { API_URL } from "../../../infrastructure/services/api/ApiUrl";
import Cookies from "js-cookie";
import AddShipperModal from "../modals/shipper/AddShipperModal";

export default function CardTableShipper({ color }) {
    ...
    <>
      ...
      >
        ...
        <div className="block w-full overflow-x-auto">
          {/* Add Stock */}
          {<AddShipperModal isOpen={isOpen} close={closeModal} />}
...
CardTableShipper.defaultProps = {
  color: "light",
};

CardTableShipper.propTypes = {
